...
> 当前 `server/data/source/` 为【模拟演示数据】，共 3 份文档（12 个切片）：
> - `园区设备运维手册-完整版.md` —— 中央空调/电梯/消防/安防门禁/供配电/给排水/光伏充电桩/BA/停车 系统说明与故障处置
> - `常见故障与处置FAQ.md` —— 20 条高频问题一问一答
> - `应急预案与SLA制度.md` —— 困人/火灾/停电/防汛/爆管预案 + 报修SLA表 + 巡检制度
>
> 多文档自动合并入库，可演示"多文档批量入库 → 跨文档检索"。
>
